...
public class Application extends Controller {
	...
	public static void index() {
		...
		//List art = AllArticles.find("order by count").fetch();
	...
	public static void fullwidth(Long a,Comment c) {
		...
		List com = Comment.find("ArticleId = ? AND isEnabled = true ",a).fetch();
...
/*	public static void adminaunthentication(String usernames,String passwords)  {
	...
	*/
	...
	public static void comment(String mailId,String name,Long articleId,String comment,Long accountId,Boolean isEnabled,String title)  {
	...
	public static void searchtagname(String tagname) {
		//List articles = AllArticles.find("IsPublished = true order by id desc").from(0).fetch(6);
		List articles = AllArticles.find("byTagName",tagname).fetch();
	...
	public static void feedbacks(String name,String mailId,String feedback) throws EmailException {
	...
	List articles = AllArticles.find("IsPublished = true order by id desc").from(7).fetch(12);
		render(articles);
	}
	public static void index3(){
		render();
	}
	public static void feedemail(Feedback a) throws EmailException {
		SimpleEmail email = new SimpleEmail();
		email.setFrom("3iosemags@gmail.com");
		email.addTo(a.mailId);
		email.setSubject("No-reply(e-mags)");
		email.setMsg("Thankyou for your Feedback");
		Mail.send(email);
		feed();
	}
	public static void deletefeed(Long id){
		Feedback f = Feedback.find("byId",id).first();
		f.delete();
		admin.feedback();
	}
}